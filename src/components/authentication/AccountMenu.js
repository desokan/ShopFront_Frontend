    ...
    <>
      ...
      <div className={classes.accountContainer}>
        <ul className={classes.accountUL}>
          <li
            className={classes.accountLi}
            onClick={() => handleClick(t("account.dashboard"))}
          >
            {t("account.dashboard")}
          </li>
          <li
            className={classes.accountLi}
            onClick={() => handleClick(t("account.orders"))}
          >
            {t("account.orders")}
          </li>
          <li
            className={classes.accountLi}
            onClick={() => handleClick(t("account.accountDetails"))}
          >
            {t("account.accountDetails")}
          </li>
          <li
            className={classes.accountLi}
            onClick={() => handleClick(t("account.wishlist"))}
          >
            {t("account.wishlist")}
          </li>
