  ...
  return (
    <section className={classes.tableContainer}>
      <div className={classes.ordersTable}>
        <div className={`${classes.titles} ${classes.paddingLeft}`}>{t("orders.table.order")}</div>
        <div className={classes.titles}>{t("orders.table.date")}</div>
        <div className={classes.titles}>{t("orders.table.status")}</div>
        <div className={classes.titles}>{t("orders.table.total")}</div>
        ...
        return (
          <div className={classes.ordersList} key={item.orderId}>
            ...
            <div className={classes.info}>
              ...
              {item.orderItemsCount === 1 ? t("orders.total.item") : t("orders.total.items")}{" "}
            </div>
            <div className={classes.info}>
